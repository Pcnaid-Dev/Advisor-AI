...
export type IconType = 'home' | 'building' | 'store' | 'folder' | 'calendar' | 'chat' | 'document' | 'creditCard' | 'sparkles' | 'search' | 'bell' | 'user' | 'send' | 'copy' | 'check' | 'bot';
...
const ICONS: Record<IconType, React.ReactElement> = {
  ...
  building: <path strokeLinecap="round" strokeLinejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m-1 4h1m5-4h1m-1 4h1m-5-4h1m-1 4h1" />,
  ...
  bot: <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-2 2-2-2z" />
};
